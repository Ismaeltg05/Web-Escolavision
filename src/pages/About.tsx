      ...
      <div className="w-full max-w-4xl">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white p-6 rounded-2xl shadow-lg text-center">
            <img src="./assets/isma.jpeg" alt="Ismael Torres" className="w-24 h-24 mx-auto rounded-full mb-4" style={{maxHeight: "256px", maxWidth: "256px"}} />
            <h2 className="text-xl font-semibold">Ismael Torres</h2>
            <p className="text-gray-600"></p>
            <p className="text-gray-500">Correo: ismaeltg@escolavision.com</p>
          </div>
          <div className="bg-white p-6 rounded-2xl shadow-lg text-center">
            <img src="./assets/adri.jpeg" alt="Adrián Ruiz" className="w-24 h-24 mx-auto rounded-full mb-4" style={{maxHeight: "256px", maxWidth: "256px"}} />
